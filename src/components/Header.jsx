...
export function Header({ cartItemCount, onCartClick, onSearch, onNavigate, isLoggedIn, userEmail, isAdmin, onLoginClick, onLogoutClick }) {
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">TechStore</h1>
          </div>
            ...
            {isLoggedIn ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="gap-2 h-10 px-3 hover:bg-gray-100"
                  >
