  ...
  useEffect(() => {
    ...
    async function loadProducts() {
      ...
      try {
        ...
        const normalized: Product[] = Array.isArray(payload)
          ? payload
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <p className="text-gray-700">
                ...
                cam kết mang đến trải nghiệm mua sắm tuyệt vời nhất cho khách hàng. Từ tư vấn 
                sản phẩm đến dịch vụ hậu mãi, TechStore luôn đồng hành cùng bạn.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Điểm đến một cửa cho công nghệ và phụ kiện mới nhất.
              </p>
            </div>
            <div>
